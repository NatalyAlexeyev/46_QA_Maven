...
public class PracticeFormTests extends TestBase {
    ...
    public void practiceFormTest() {
        new PracticeFormPage(app.driver)
                .enterPersonalData("Sofya", "Müller", "email@gmail.com", "1234567899")
                .selectGender("Female")
                .chooseDateAsString("15 May 2005")
                .chooseDate("15", "May", "2005")
                .enterSubject(new String[]{"Maths", "English"})
                .chooseHobbies(new String[]{"Sports", "Music"})
                .uploadPicture("C:/Users/natal/Desktop/1/111.jpg")
                .enterCurrentAddress("Germany, Köln, GDR")
                .enterState("NCR")
                .enterCity("Delhi")
                .submitForm()
